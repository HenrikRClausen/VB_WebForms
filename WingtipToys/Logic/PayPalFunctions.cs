...
public class NVPAPICaller {
    ...
    public string APIUsername = "henrik-testbruger_api1.fangorn.dk";
    ...
    public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg) {
        ...
        string returnURL = "http://localhost:50108/Checkout/CheckoutReview.aspx";
        string cancelURL = "http://localhost:50108/Checkout/CheckoutCancel.aspx";
    ...
    public bool GetCheckoutDetails(string token, ref string PayerID, ref NVPCodec decoder, ref string retMsg) {
        ...
        string strAck = decoder["ACK"].ToLower();
        if (strAck != null && (strAck == "success" || strAck == "successwithwarning")) {
            PayerID = decoder["PAYERID"]; return true;
            }
        else {
            retMsg = "ErrorCode=" + decoder["L_ERRORCODE0"] + "&" + "Desc=" + decoder["L_SHORTMESSAGE0"] + "&" + "Desc2=" + decoder["L_LONGMESSAGE0"];
            return false;
